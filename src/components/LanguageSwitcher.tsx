...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-xl border border-white/20 text-white/90"
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 z-50 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-52">
            <div className="px-4 py-3 border-b border-gray-50">
              <p className="text-xs font-black text-gray-500 uppercase tracking-wide">Bhasha Chunein</p>
            </div>
              ...
              {LANGUAGES.map((l) => (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className={`text-sm font-bold leading-none ${lang === l.code ? "text-violet-700" : "text-gray-800"}`}>{l.native}</p>
