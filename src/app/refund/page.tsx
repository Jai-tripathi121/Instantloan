  ...
  return (
    <div className="min-h-dvh max-w-2xl mx-auto px-5 py-8" style={{ background: "var(--bg)" }}>
      ...
      <div className="space-y-5 text-sm leading-relaxed" style={{ color: "var(--ink-soft)" }}>
        {[
          ["1. Service Provider", "This Cancellation & Refund Policy applies to payments made to POSTMAC VENTURES PRIVATE LIMITED (CIN: U66190HR2025PTC129138) for the postmoney AI Eligibility Report service."],
          ["2. Nature of the Charge", "The ₹99 fee is a one-time charge for AI-based bank statement analysis, profile matching against 33+ bank eligibility criteria, and delivery of a personalised loan eligibility report. This is a digital service delivered instantly upon payment."],
