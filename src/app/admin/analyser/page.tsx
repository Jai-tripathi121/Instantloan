                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-5">
                    <h3 className="font-semibold text-gray-900 flex items-center gap-2">
                      ...
                      AI Insights — Powered by Post AI
                    </h3>
                    <div className="flex gap-2">
                      <button
                    ...
                    <div className="lg:col-span-2 bg-gradient-to-br from-violet-50 to-indigo-50 border border-violet-100 rounded-2xl p-5">
                      ...
                      {aiLoading && !aiInsights ? (
                        <div className="flex items-center gap-3 py-8 justify-center">
                          ...
                          <span className="text-sm text-violet-600">Post AI is analysing your statement…</span>
                        </div>
                      ) : aiInsights ? (
                    ...
                    <div className="min-h-48 max-h-80 overflow-y-auto p-4 space-y-3 bg-white">
                      {chatMessages.length === 0 && (
                        <div className="text-center py-6">
                          ...
                          <p className="text-sm text-gray-400">Ask Post AI about your bank statement</p>
