  ...
  return (
    <div className="min-h-dvh max-w-2xl mx-auto px-5 py-8" style={{ background: "var(--bg)" }}>
      ...
      <div className="space-y-5 text-sm leading-relaxed" style={{ color: "var(--ink-soft)" }}>
        {[
          ["1. Company Identity", "This Privacy Policy applies to postmoney, a product of POSTMAC VENTURES PRIVATE LIMITED (CIN: U66190HR2025PTC129138, PAN: AAPCP5039G), a private limited company incorporated under the Companies Act 2013, registered at 3rd Floor, Orchid Center, Golf Course Road, Sector-53, DLF QE, Gurugram, Haryana – 122002."],
          ...
          ["6. DPDP Act 2023 Compliance", "We comply with India's Digital Personal Data Protection Act 2023. You have the right to: (a) access your stored data; (b) correct inaccurate data; (c) request erasure of your data; (d) withdraw consent. To exercise these rights, email privacy@postmoney.in."],
          ...
          ["10. Contact for Privacy", "For privacy concerns or data requests: privacy@postmoney.in | POSTMAC VENTURES PRIVATE LIMITED, 3rd Floor, Orchid Center, Golf Course Road, Gurugram, Haryana – 122002."],
        ].map(([title, body]) => (
